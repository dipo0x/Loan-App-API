...
module.exports.register = async function (req, res, next) {
  try {
    ...
    if (!valid) {
      ...
      const accessToken = jwt.sign({ _id: user.newUser.id }, seeders[NodeEnv].jwt_access_token_secret, {
        expiresIn: seeders[NodeEnv].jwt_expiry_time,
      });
...
module.exports.login = async function (req, res, next) {
  try {
    ...
    const accessToken = jwt.sign({ _id: user.id }, seeders[NodeEnv].jwt_access_token_secret, {
      expiresIn: seeders[NodeEnv].jwt_expiry_time,
    });
